...
//   void loadModel(string const &path, bool flip_image) {
...
//   // any).
//   void processNode(aiNode *node, const aiScene *scene, bool flip_image) {
...
//       meshes.push_back(processMesh(mesh, scene, flip_image));
//     }
//     // after we've processed all of the meshes (if any) we then recursively
//     // process each of the children nodes
//     for (unsigned int i = 0; i < node->mNumChildren; i++) {
//       processNode(node->mChildren[i], scene, flip_image);
//     }
//   }

//   Mesh processMesh(aiMesh *mesh, const aiScene *scene, bool flip_image) {
//     // data to fill
...
//       vector for (unsigned int j = 0; j < face.mNumIndices; j++)
...
//         material, aiTextureType_DIFFUSE, "texture_diffuse", flip_image);
//     textures.insert(textures.end(), diffuseMaps.begin(), diffuseMaps.end());
//     // 2. specular maps
//     vector<Texture> specularMaps = loadMaterialTextures(
//         material, aiTextureType_SPECULAR, "texture_specular", flip_image);
//     textures.insert(textures.end(), specularMaps.begin(),
//     specularMaps.end());
//     // 3. normal maps
//     std::vector<Texture> normalMaps = loadMaterialTextures(
//         material, aiTextureType_HEIGHT, "texture_normal", flip_image);
//     textures.insert(textures.end(), normalMaps.begin(), normalMaps.end());
//     // 4. height maps
//     std::vector<Texture> heightMaps = loadMaterialTextures(
//         material, aiTextureType_AMBIENT, "texture_height", flip_image);
...
//   struct. vector<Texture> loadMaterialTextures(aiMaterial *mat, aiTextureType
//   type,
//                                        string typeName, bool flip_image) {
//     vector<Texture> textures;
...
//         flip_image); texture.type = typeName; texture.path = str.C_Str();
