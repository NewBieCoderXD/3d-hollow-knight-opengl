...
int main()
{
    ...
    // -------------------------
    Shader texturedModelShader("src/texturedModel.vert","src/texturedModel.frag");

    // load models
    // -----------
    Model knightModel(FileSystem::getPath("resources/hollow-knight-the-knight/source/Knight.obj"),false);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        knightModel.Draw(texturedModelShader);
